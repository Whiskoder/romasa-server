...
export class UpdateServiceOperationsTable1759968576826 implements MigrationInterface {
    name = 'UpdateServiceOperationsTable1759968576826'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_operations" ADD "diagnosticAppoinmentDate" datetime`);
        await queryRunner.query(`ALTER TABLE "service_operations" ADD "approvedByDepartmentManager" bit NOT NULL CONSTRAINT "DF_20652339b9b26744b7dd5935f3c" DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE "service_operations" ADD "approvedByDriver" bit NOT NULL CONSTRAINT "DF_18b20c5bb64520216050b6f53f3" DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE "service_operations" DROP CONSTRAINT "FK_761957cd77cec26dc3276225189"`);
        ...
        await queryRunner.query(`ALTER TABLE "service_operations" DROP CONSTRAINT "FK_f0bde98434ab631af91005539e2"`);
        await queryRunner.query(`ALTER TABLE "service_operations" DROP CONSTRAINT "FK_23b236f1a336509c87863ed0c49"`);
        await queryRunner.query(`ALTER TABLE "service_operations" DROP CONSTRAINT "FK_d093ecef300b191a892e89aa82b"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_a7191f881489123fab6c8e52738" FOREIGN KEY ("employeeId") REFERENCES "TBLCATEMP"("LNGCLVEMP") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_operations" ADD CONSTRAINT "FK_f0bde98434ab631af91005539e2" FOREIGN KEY ("createdByEmployeeId") REFERENCES "TBLCATEMP"("LNGCLVEMP") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_operations" ADD CONSTRAINT "FK_23b236f1a336509c87863ed0c49" FOREIGN KEY ("departmentManagerEmployeeId") REFERENCES "TBLCATEMP"("LNGCLVEMP") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_operations" ADD CONSTRAINT "FK_d093ecef300b191a892e89aa82b" FOREIGN KEY ("vehicleDriverEmployeeId") REFERENCES "TBLCATEMP"("LNGCLVEMP") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_operations" ADD CONSTRAINT "FK_761957cd77cec26dc3276225189" FOREIGN KEY ("vehicleId") REFERENCES "TBLTRNVHC_CP"("LNGDNTTRN") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        // await queryRunner.query(`ALTER TABLE "TBLTRNVHC_CP" ADD CONSTRAINT "PK_164f7f5ae561a5ae8f96953dd3d" PRIMARY KEY ("LNGDNTTRN")`);
        await queryRunner.query(`ALTER TABLE "service_operations" ADD CONSTRAINT "FK_761957cd77cec26dc3276225189" FOREIGN KEY ("vehicleId") REFERENCES "TBLTRNVHC_CP"("LNGDNTTRN") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_operations" DROP CONSTRAINT "DF_18b20c5bb64520216050b6f53f3"`);
        await queryRunner.query(`ALTER TABLE "service_operations" DROP COLUMN "approvedByDriver"`);
        await queryRunner.query(`ALTER TABLE "service_operations" DROP CONSTRAINT "DF_20652339b9b26744b7dd5935f3c"`);
        await queryRunner.query(`ALTER TABLE "service_operations" DROP COLUMN "approvedByDepartmentManager"`);
        await queryRunner.query(`ALTER TABLE "service_operations" DROP COLUMN "diagnosticAppoinmentDate"`);
