...
export class UpdateServiceOperations1760052966437 implements MigrationInterface {
    name = 'UpdateServiceOperations1760052966437'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_operations" DROP CONSTRAINT "FK_a9b9ff16699e1981c1ad05e00ee"`);
        ...
        await queryRunner.query(`ALTER TABLE "service_operations" ALTER COLUMN "approvedByDriver" bit`);
        ...
        await queryRunner.query(`ALTER TABLE "service_operations" ADD CONSTRAINT "FK_a9b9ff16699e1981c1ad05e00ee" FOREIGN KEY ("scheduledByEmployeeId") REFERENCES "TBLCATEMP"("LNGCLVEMP") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_operations" DROP CONSTRAINT "FK_f0bde98434ab631af91005539e2"`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_a7191f881489123fab6c8e52738"`);
        await queryRunner.query(`ALTER TABLE "service_operations" ADD CONSTRAINT "DF_18b20c5bb64520216050b6f53f3" DEFAULT 0 FOR "approvedByDriver"`);
        await queryRunner.query(`ALTER TABLE "service_operations" ALTER COLUMN "approvedByDriver" bit NOT NULL`);
        await queryRunner.query(`ALTER TABLE "TBLCATEMP" DROP COLUMN "SSMA_TimeStamp"`);
