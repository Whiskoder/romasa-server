...
export class CreateUserTable1759595204430 implements MigrationInterface {
    name = 'CreateUserTable1759595204430'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uniqueidentifier NOT NULL, "role" nvarchar(50) NOT NULL, "hashedPassword" nvarchar(60), "email" nvarchar(255) NOT NULL, "isActive" bit NOT NULL CONSTRAINT "DF_409a0298fdd86a6495e23c25c66" DEFAULT 1, "encryptedTokenSecret" varbinary(255) NOT NULL, "createdAt" datetime NOT NULL CONSTRAINT "DF_204e9b624861ff4a5b268192101" DEFAULT getdate(), "updatedAt" datetime NOT NULL CONSTRAINT "DF_0f5cbe00928ba4489cc7312573b" DEFAULT getdate(), "employeeId" int, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
