...
export class UpdateUsersTable1760032992219 implements MigrationInterface {
    name = 'UpdateUsersTable1760032992219'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "branch" nvarchar(50) NOT NULL CONSTRAINT "DF_afbfe3b3a66d1b633cf7faa50ae" DEFAULT 'romasa'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "TBLTRNVHC_CP" ADD CONSTRAINT "PK_164f7f5ae561a5ae8f96953dd3d" PRIMARY KEY ("LNGDNTTRN")`);
        await queryRunner.query(`ALTER TABLE "service_operations" ADD CONSTRAINT "FK_761957cd77cec26dc3276225189" FOREIGN KEY ("vehicleId") REFERENCES "TBLTRNVHC_CP"("LNGDNTTRN") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "DF_afbfe3b3a66d1b633cf7faa50ae"`);
