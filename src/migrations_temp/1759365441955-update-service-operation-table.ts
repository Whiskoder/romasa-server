...
export class UpdateServiceOperationTable1759365441955
  implements MigrationInterface
{
  name = 'UpdateServiceOperationTable1759365441955';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_operations" ALTER COLUMN "vehicleId" int`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_operations" ALTER COLUMN "vehicleId" int NOT NULL`,
    );
    // await queryRunner.query(`ALTER TABLE "TBLTRNVHC_CP" DROP COLUMN "SSMA_TimeStamp"`);
